...
namespace BitcoinExample
{
    class BitcoinAddressGenerator
    {
        ...
        public static byte[] HexToByte(string HexString)
        {
            ...
            {
                res[i] = byte.Parse(HexString.Substring(i * 2, 2), NumberStyles.HexNumber, CultureInfo.InvariantCulture);
            }
        ...
        {
            // WARNING: The RIPEMD is missing from my Mac installation of mono! I dont have the energy to sigure out why! This is why the implementation is replaced with another SHA256!
            // MICROSOFT SUX!
            SHA256Managed hashstring = new SHA256Managed();
            return hashstring.ComputeHash(array);
        }
