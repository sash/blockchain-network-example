                ...
                <div id="faucet">
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <small id="emailHelp" class="form-text text-muted">We have {{$balance['confirmed']}}[{{$balance['unconfirmed']}}] coins left</small>
                            <small>If you dont need the coins, you can send it back at <code>{{$address}}</code></small>
